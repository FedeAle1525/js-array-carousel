...
rightBtnArrow.addEventListener('click', function(){
  ...
  // 7.1 - Aggiungo Controllo per evitare errore e fermare l'azione all'Ultima Slide Possibile
  if (indexCurrentSlide < slideElements.length - 1){
    ...
    // 7.3 - Incremento Indice per trovare Slide Successiva
...
leftBtnArrow.addEventListener('click', function(){
  ...
  // 9.1 - Aggiungo Controllo per evitare errore e fermare l'azione alla Prima Slide Possibile
  if (indexCurrentSlide > 0){
    ...
    // 9.3 - Decremento Indice per trovare Slide Precedente
    indexCurrentSlide = indexCurrentSlide - 1;
